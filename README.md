...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/kathgironpe/yadr/main/install.sh`"
```
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/kathgironpe/yadr/main/install.sh`" -s ask
```
